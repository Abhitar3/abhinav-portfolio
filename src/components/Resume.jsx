function Resume() {
  return (
    <section id="resume" className="px-5 py-16 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-5xl rounded-lg border border-[#C9A646]/30 bg-white p-8 text-center shadow-2xl shadow-black/25">
        <p className="text-sm font-semibold uppercase tracking-[0.24em] text-[#9A7A22]">Resume</p>
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="mt-7 inline-flex rounded-full bg-[#071126] px-6 py-3 text-sm font-bold text-white transition hover:-translate-y-0.5 hover:bg-[#9A7A22]"
        >
          Download Resume
        </a>
      </div>
